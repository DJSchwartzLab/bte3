...
READSDIR=${BASEDIR}/bfrag_isolates/bte1_2/bbmap_repaired
SAMPLE=`sed -n ${SLURM_ARRAY_TASK_ID}p ${BASEDIR}/bfrag_isolates/bte1_2/bte1_2_mappingfile.txt`
REF=bte3
REF_INDEX=${BASEDIR}/bte_reference_sequences/${REF}/${REF} # Specify the full path to the index prefix

OUTDIR=${BASEDIR}/bfrag_isolates/bte1_2/bowtie2_${REF}/${SAMPLE}_${REF}
