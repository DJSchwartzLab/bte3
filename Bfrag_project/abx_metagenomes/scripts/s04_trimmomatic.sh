...
BASEDIR="/scratch/djslab/jltung/Bfrag_project/abx_metagenomes"
...
# abx_metagenomes_mappingfile.txt contains a list of all file names
sample=`sed -n ${SLURM_ARRAY_TASK_ID}p ${BASEDIR}/abx_metagenomes_mappingfile.txt`
# R1 = FWW and R2 = RV
...
${INDIR}/${sample}.trimmo.60.um.1.fastq \
${INDIR}/${sample}.trimmo.60.um.2.fastq \
