...
INDIR="/scratch/djslab/jltung/Bfrag_project/abx_metagenomes/trimmed"
OUTDIR="/scratch/djslab/jltung/Bfrag_project/abx_metagenomes/deconseq_out"

# Create output directory if it doesn't exist
mkdir -p ${OUTDIR}

# Samples for slurm array
ID=`sed -n ${SLURM_ARRAY_TASK_ID}p /scratch/djslab/jltung/Bfrag_project/abx_metagenomes/abx_metagenomes_mappingfile.txt`
