...
# Usage        : sbatch s10_bowtie2_bte2.sh
...
READSDIR=${BASEDIR}/RobertThanertNEC_metagenomes/bbmap_repaired
SAMPLE=`sed -n ${SLURM_ARRAY_TASK_ID}p ${BASEDIR}/RobertThanertNEC_metagenomes/RobertThanertNEC_metagenomes_mappingfile.txt`
REF=bte2
REF_INDEX=${BASEDIR}/bte_reference_sequences/${REF}/${REF} # Specify the full path to the index prefix

OUTDIR=${BASEDIR}/RobertThanertNEC_metagenomes/bowtie2_${REF}/${SAMPLE}_${REF}
