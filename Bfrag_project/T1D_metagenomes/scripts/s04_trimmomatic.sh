...
BASEDIR="/scratch/djslab/jltung/Bfrag_project/T1D_metagenomes"
...
adapt="/ref/djslab/data/trimmomatic_adapters/0.39/TruSeq3-PE-2.fa"

# T1D_metagenomes_mappingfile.txt contains a list of all file names
sample=`sed -n ${SLURM_ARRAY_TASK_ID}p ${BASEDIR}/T1D_metagenomes_mappingfile.txt`
# R1 = FWW and R2 = RV
