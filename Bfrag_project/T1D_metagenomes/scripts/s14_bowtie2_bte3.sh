...
READSDIR=${BASEDIR}/T1D_metagenomes/bbmap_repaired
SAMPLE=`sed -n ${SLURM_ARRAY_TASK_ID}p ${BASEDIR}/T1D_metagenomes/T1D_metagenomes_mappingfile.txt`
REF=bte3
REF_INDEX=${BASEDIR}/bte_reference_sequences/${REF}/${REF} # Specify the full path to the index prefix

OUTDIR=${BASEDIR}/T1D_metagenomes/bowtie2_${REF}/${SAMPLE}_${REF}
