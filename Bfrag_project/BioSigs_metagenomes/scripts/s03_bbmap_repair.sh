...
BASEDIR="/scratch/djslab/jltung/Bfrag_project/BioSigs_metagenomes"
...
ID=`sed -n ${SLURM_ARRAY_TASK_ID}p ${BASEDIR}/BioSigs_metagenomes_mappingfile.txt`

#Run repair
repair.sh --tossbrokenreads \
    in1=${INDIR}/${ID}_FW_CLEAN.fastq \
    in2=${INDIR}/${ID}_RV_CLEAN.fastq \
