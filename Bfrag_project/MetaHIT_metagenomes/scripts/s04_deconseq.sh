...
INDIR="/scratch/djslab/jltung/Bfrag_project/MetaHIT_metagenomes/downloaded_reads"
OUTDIR="/scratch/djslab/jltung/Bfrag_project/MetaHIT_metagenomes/deconseq_out"

# Create output directory if it doesn't exist
mkdir -p ${OUTDIR}

# Samples for slurm array
ID=`sed -n ${SLURM_ARRAY_TASK_ID}p /scratch/djslab/jltung/Bfrag_project/MetaHIT_metagenomes/MetaHIT_metagenomes_mappingfile.txt`
